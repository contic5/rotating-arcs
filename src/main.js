...
function main()
{
    ...
    for(let layer=0;layer<max_layers;layer++)
    {
        ...
        let layer_arcs=min_layer_arcs;
        if(add_arc_for_each_layer)
        {
            layer_arcs+=layer;
        }
...
export function update_values()
{
    ...
    UniqueArc.uneven_rotation_speed=document.getElementById("uneven_rotation_speed").checked;

    background_color=document.getElementById("background_color").value;

    UniqueArc.using_one_color=document.getElementById("using_one_color").checked;

    UniqueArc.drawing_color=document.getElementById("drawing_color").value;

    add_arc_for_each_layer=document.getElementById("add_arc_for_each_layer").checked;
